...
class potato_msv_rifleman { // rifleman
  ...
  vest[] = {"CUP_V_RUS_6B45_1_BeigeDigital","CUP_V_RUS_6B45_2_BeigeDigital","CUP_V_RUS_6B45_3_BeigeDigital"};
...
class potato_msv_sl: potato_msv_sr { // SL
  ...
  items[] += {RADIO_MR,"CUP_H_RUS_6B27_cover_BeigeDigital_headset"};
};
